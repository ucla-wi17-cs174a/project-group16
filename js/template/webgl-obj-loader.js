// Google this filename for the complete, commented version
...
OBJ.Mesh = function (objectData)
  ...
  var Ajax = function()
  {
    ...
    this.get = function(url, callback)  {
      ...
      _this.xmlhttp.overrideMimeType( "application/json" );   _this.xmlhttp.open('GET', url, true);   _this.xmlhttp.send();
    }
  };
